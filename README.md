...
| | |
|---|---|
| [Requirements specification](docs/requirements-spec.md) | Scope, hypotheses, F-1 – F-24, non-goals, threats to validity, the MPR ladder. **Start here.** Generated from the `.docx`, which is the source of truth. |
| [SCOPE-CHANGE-001](docs/SCOPE-CHANGE-001.md) | Decision record: why the pool moved to a single inference engine. Now integrated into the spec. |
