...
service-time residuals are bimodal, and it graded us against IEEE acceptance when October is
a checkpoint. The policy and simulator defects are fixed and pushed. What remains is
